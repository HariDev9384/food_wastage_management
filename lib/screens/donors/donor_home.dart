...
import '../recipients/Tabs/RecipientHomeTab.dart';
...
if(dish_name!=null&&donor_name!=null&&price!=null&&quantity!=null&&desc!=null){
    ...
    final dish=Add_Dishes(  dish_name: dish_name, donor_name: donor_name, quantity: quantity, desc: desc, price: price);
